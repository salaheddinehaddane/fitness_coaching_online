                    ...
                    <ul class="metismenu" id="menu">
                        <li>
                            ...
                            <ul aria-expanded="false">
                                <li>
                                    <router-link to="/coach/accueille"> Accueille </router-link>
                                </li>
                                {{-- <li><a href="index.html">Accueill</a></li> --}}
                                <li>
                                    <router-link to="/coach/coach-entrainement"> Entrainement </router-link>
                                </li>
                                <li>
                                    <router-link to="/coach/coach-nutrition"> Nutrition </router-link>
                                </li>
                                <li>
                                    <router-link to="/coach/coach-clients"> Mes Clients </router-link>
                                </li>
                                <li>
                                    <router-link to="/coach/coach-coaching"> Demande de coaching </router-link>
                                </li>
                                <li>
                                    <router-link to="/coach/coach-motpasse"> Changer mot de passe </router-link>
                                </li>
