                    ...
                    <ul class="metismenu" id="menu">
                        <li>
                            ...
                            <ul aria-expanded="false">
                                <li>
                                    <router-link to="/client/client-accueille"> Accueille </router-link>
                                </li>
                                <li>
                                    <router-link to="/client/client-entrainement"> Mes entrainements </router-link>
                                </li>
                                <li>
                                    <router-link to="/client/client-nutrition"> Mes nutritions </router-link>
                                </li>
                                <li>
                                    <router-link to="/client/client-hebdo"> Bilan hebdomadaire </router-link>
                                </li>
                                <li>
                                    <router-link to="/client/client-motpasse"> Changer mot de passe </router-link>
                                </li>
